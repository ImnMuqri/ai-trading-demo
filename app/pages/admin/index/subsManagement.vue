  ...
  <div class="text-white">
    <UiCard class="py-2 text-[12px] h-full min-h-[300px] flex-1">
      ...
      <UiTable
        ...
        :rowsPerPage="subscriptionPlans.length"
        empty-class="min-h-[400px]">
        <template #header>
          <div class="grid grid-cols-7 gap-2">
            <div class="text-gray-300 font-bold">ID</div>
            <div class="text-gray-300 font-bold">Name</div>
            <div class="text-gray-300 font-bold">Request Limit</div>
            <div class="text-gray-300 font-bold">Price</div>
            <div class="text-gray-300 font-bold">Duration (days)</div>
            <div class="text-gray-300 font-bold">Active</div>
