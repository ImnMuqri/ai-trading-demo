              ...
              <div class="flex flex-col gap-5">
                <div>
                  ...
                  <p class="text-xl font-semibold text-[#00BDA7]">
                    {{
                      $formatNumber(adminSummary?.affiliatorSummary?.total) ??
                      "No Data"
                    }}
                  </p>
                </div>
                <div>
                  ...
                  <p class="text-sm font-medium text-white">
                    {{
                      $formatNumber(adminSummary?.affiliatorSummary?.today) ??
                      "No Data"
                    }}
                  </p>
                </div>
          ...
          <div
            ...
            <div class="flex flex-col gap-1.5 text-white">
              <div>
                ...
                <p class="text-xl font-semibold text-[#00BDA7]">
                  {{
                    $formatNumber(adminSummary?.clientSummary?.total) ??
                    "No Data"
                  }}
                </p>
              </div>
              ...
              <div>
                ...
                <p class="text-sm font-medium">
                  {{
                    $formatNumber(adminSummary?.clientSummary?.today) ??
                    "No Data"
                  }}
                </p>
              </div>
              ...
              <div>
                ...
                <p class="text-sm font-medium">
                  {{
                    $formatNumber(adminSummary?.clientSummary?.last30Days) ??
                    "No Data"
                  }}
                </p>
              </div>
              ...
              <div>
                ...
                <p class="text-sm font-semibold">
                  {{
                    $formatNumber(adminSummary?.clientSummary?.last60Days) ??
                    "No Data"
                  }}
                </p>
              </div>
            ...
            <div class="flex flex-col gap-8 text-white">
              <div>
                ...
                <p class="text-sm font-semibold">
                  {{
                    $formatNumber(
                      adminSummary?.clientSummary?.clientType?.Free
                    ) ?? "No Data"
                  }}
                </p>
              </div>
              ...
              <div>
                ...
                <p class="text-sm font-semibold text-[#00BDA7]">
                  {{
                    $formatNumber(
                      adminSummary?.clientSummary?.clientType?.["Primary Tier"]
                    ) ?? "No Data"
                  }}
                </p>
              </div>
...
const clientStatusProgress = computed(() => {
  const status = adminSummary.value.clientsStatus;
...
const getAnalytics = async () => {
  ...
  try {
    ...
    if (resp.data.data) {
      adminSummary.value = resp.data.data;
    }
